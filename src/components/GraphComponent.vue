    ...
    // Método para obtener los datos de las citas desde la API y actualizar la gráfica
      async fetchAndDrawChart() {
        try {
          ...
          const appointmentsLastWeek = this.filterAppointmentsLastWeek(appointments);
